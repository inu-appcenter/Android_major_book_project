package com.example.majorbookservice.ui.savedbook
...
import com.example.majorbookservice.DividerItemDecoration
import com.example.majorbookservice.R
import com.example.majorbookservice.databinding.ActivitySavedBookBinding
import com.metacoding.major_book.SavedBookAdapter

class RecyclerViewActivity : AppCompatActivity(), SavedBookAdapter.ItemClickListener {

    private lateinit var binding: ActivitySavedBookBinding
    private lateinit var myAdapter: SavedBookAdapter
...
//        toolbarBodyTemplate.title = "신체 템플릿"
        ...
        myAdapter = SavedBookAdapter(books, this)
